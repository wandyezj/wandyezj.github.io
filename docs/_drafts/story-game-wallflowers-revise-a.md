...
1. Give each player a blank index card and have them write down their _wallflower alias_ on one side, leaving the back blank.
...
- Sequencing explanation needs improvement - procedure should be linear.
- It's hard to start play, consider having each wallflower as an opening scene describe a person or group they think will be there and what they think of them
- Write out guidelines for playtest
- Release a playtest version
- Be clear on what to read out loud
- Separate rules from examples
- Have people describe a specific thing
- Describe alternative settings - like the woods
- Clearly explain you can't actually join or leave until bloom
- Clearly explain scene rules
    - What is happening right now
    - something specific
    - zoom in on a few people
- Clarify why it's the player verses the wallflower
- Update wording - build on something is clunky
- Flower names tend to be feminine - does this bias the players? Solution?
- Drawing randomly doesn't always work, look at the last so you don't narrate your own scene
- Really going for immersive
- Include player name on wallflower cards?
- Clarify deck drawing rules - for the last two cards. Explain overall goals
- Simplify game rule test.



Things that worked well

- Unexpected draw is solid
- Separation of party narration and wallflower reaction on different players is good
- Explanation of author intent is good - so people know what you are going for.


Possibly masculine flower names
...
Limit what is one each page so people can go through step by step

Decide on Layout of Left and Right pages

- Cover: Title: Wallflowers + Abstract Wallflower Image
- Left: Blank & Right: Pitch
- Left: Blank & Right: What you need to play
- Left: Blank & Introduction
...
- Design Theory - what the game is about.
- FAQ
- by wandyezj + Logo
- Acknowledgements